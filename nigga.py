...
chess_pieces_path = path.join('img', 'chess_pieces')

bp = Piece('b', 'p', path.join(chess_pieces_path, 'b_pawn.png'))
wp = Piece('w', 'p', path.join(chess_pieces_path, 'w_pawn.png'))
bk = Piece('b', 'k', path.join(chess_pieces_path, 'b_king.png'))
wk = Piece('w', 'k', path.join(chess_pieces_path, 'w_king.png'))
br = Piece('b', 'r', path.join(chess_pieces_path, 'b_rook.png'))
wr = Piece('w', 'r', path.join(chess_pieces_path, 'w_rook.png'))
bb = Piece('b', 'b', path.join(chess_pieces_path, 'b_bishop.png'))
wb = Piece('w', 'b', path.join(chess_pieces_path, 'w_bishop.png'))
bq = Piece('b', 'q', path.join(chess_pieces_path, 'b_queen.png'))
wq = Piece('w', 'q', path.join(chess_pieces_path, 'w_queen.png'))
bkn = Piece('b', 'kn', path.join(chess_pieces_path, 'b_knight.png'))
wkn = Piece('w', 'kn', path.join(chess_pieces_path, 'w_knight.png'))


starting_order = {(0, 0): br.draw(), (1, 0): bkn.draw(),
                  (2, 0): bb.draw(), (3, 0): bq.draw(),
                  (4, 0): bk.draw(), (5, 0): bb.draw(),
                  (6, 0): bkn.draw(), (7, 0): br.draw(),
                  
                  (0, 1): bp.draw(), (1, 1): bp.draw(),
                  (2, 1): bp.draw(), (3, 1): bp.draw(),
                  (4, 1): bp.draw(), (5, 1): bp.draw(),
                  (6, 1): bp.draw(), (7, 1): bp.draw(),
                  ...
                  (0, 6): wp.draw(), (1, 6): wp.draw(),
                  (2, 6): wp.draw(), (3, 6): wp.draw(),
                  (4, 6): wp.draw(), (5, 6): wp.draw(),
                  (6, 6): wp.draw(), (7, 6): wp.draw(),
                  
                  (0, 7): wr.draw(), (1, 7): wkn.draw(),
                  (2, 7): wb.draw(), (3, 7): wq.draw(),
                  (4, 7): wk.draw(), (5, 7): wb.draw(),
                  (6, 7): wkn.draw(), (7, 7): wr.draw(), }
    ...
    def setup(self, WIN):
        if starting_order[(self.row, self.col)]:
            if starting_order[(self.row, self.col)] == None:
                ...
                WIN.blit(
                    starting_order[(self.row, self.col)], (self.x, self.y))
